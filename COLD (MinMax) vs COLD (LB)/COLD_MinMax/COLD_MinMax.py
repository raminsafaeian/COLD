...
def FullIdentificationHauserLUT(neigh,Config,MAXnIntervention):
    ...
    while E > 0 :
        ...
        _,v = BestNodeHauserLUT(neigh["graph"],E,MeekObj,Config)   
...
def BestNodeHauserLUT(neigh,nAllEdges,MeekObj,Config):
